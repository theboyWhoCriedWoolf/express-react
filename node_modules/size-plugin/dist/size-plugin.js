...
SizePlugin.prototype.apply = function apply (compiler) {
    return new Promise((function ($return, $error) {
        ...
        compiler.hooks.afterEmit.tapPromise(NAME, function (compilation) { return this$1.outputSizes(compilation.assets).catch(console.error); });
        return $return();
    }).bind(this));
};
...
SizePlugin.prototype.getSizes = function getSizes (cwd) {
    return new Promise((function ($return, $error) {
        ...
        return glob(this.pattern, {
            ...
            try {
                files = $await_3;
                return Promise.all(files.map(function (file) { return gzipSize.file(path.join(cwd, file)); })).then((function ($await_4) {
                        var this$1 = this;
